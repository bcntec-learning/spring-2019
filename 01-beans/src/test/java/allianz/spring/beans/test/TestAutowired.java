...
import allianz.spring.beans.b_injection.InjectAndAutoWiredContext;
import allianz.spring.beans.b_injection.MyFirstBean;
import allianz.spring.beans.b_injection.MyFirstByConstructor;
import allianz.spring.beans.b_injection.MyFirstBySetter;
...
public class TestAutowired {
    ...
    public void byQualifier_not_null() {
        ...
        assertEquals("hello sub2 MyFirstBean2!!!!!!", byQualifier.hello());
    ...
    public void bySetter_not_null() {
        ...
        assertEquals("hello sub2 MyFirstBean2!!!!!!->hello sub2 MyFirstBean2!!!!!!",bySetter.hello());
